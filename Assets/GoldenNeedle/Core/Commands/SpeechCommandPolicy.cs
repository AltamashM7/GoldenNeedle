    ...
    public sealed class SpeechCommandConfiguration
    {
        ...
        public static SpeechCommandConfiguration CreateDefault()
        {
            return new SpeechCommandConfiguration
            {
                ...
                mappings = new[]
                {
                    new SpeechCommandMapping("begin calibration", GoldenNeedleCommand.BeginCalibration, minimumConfidence: SpeechRecognitionConfidence.Low),
                    new SpeechCommandMapping("reset calibration", GoldenNeedleCommand.ResetCalibration, minimumConfidence: SpeechRecognitionConfidence.Low),
                    new SpeechCommandMapping("recenter", GoldenNeedleCommand.Recenter, minimumConfidence: SpeechRecognitionConfidence.Low),
                    new SpeechCommandMapping("retry tracking", GoldenNeedleCommand.RetryTracking, minimumConfidence: SpeechRecognitionConfidence.Low),
                    new SpeechCommandMapping("game view", GoldenNeedleCommand.SetGamePresentation, minimumConfidence: SpeechRecognitionConfidence.Low),
                    new SpeechCommandMapping("lab view", GoldenNeedleCommand.SetLabPresentation, minimumConfidence: SpeechRecognitionConfidence.Low),
                    new SpeechCommandMapping("back view", GoldenNeedleCommand.SelectCameraViewPreset, "Back", SpeechRecognitionConfidence.Low),
                    new SpeechCommandMapping("front view", GoldenNeedleCommand.SelectCameraViewPreset, "Front", SpeechRecognitionConfidence.Low),
                    new SpeechCommandMapping("left view", GoldenNeedleCommand.SelectCameraViewPreset, "Left", SpeechRecognitionConfidence.Low),
                    new SpeechCommandMapping("right view", GoldenNeedleCommand.SelectCameraViewPreset, "Right", SpeechRecognitionConfidence.Low),
                    new SpeechCommandMapping("full body view", GoldenNeedleCommand.SelectCameraViewPreset, "FullBody", SpeechRecognitionConfidence.Low),
                    new SpeechCommandMapping("hands view", GoldenNeedleCommand.SelectCameraViewPreset, "Hands", SpeechRecognitionConfidence.Low),
                    new SpeechCommandMapping("left hand view", GoldenNeedleCommand.SelectCameraViewPreset, "LeftHand", SpeechRecognitionConfidence.Low),
                    new SpeechCommandMapping("right hand view", GoldenNeedleCommand.SelectCameraViewPreset, "RightHand", SpeechRecognitionConfidence.Low),
                },
            };
        }
    }
