...
namespace GoldenNeedle.Core.Motion.Locomotion
{
    ...
    public sealed class CadenceDetectorSettings
    {
        ...
        [Tooltip("Virtual travel distance contributed by each detected cadence step.")]
        [Min(0.05f), InspectorName("Distance Per Step")]
        public float virtualStridePerStep = 0.60f;

        [Tooltip("Maximum virtual travel speed generated by cadence.")]
        [Min(0.1f), InspectorName("Maximum Cadence Speed")]
        public float maximumVirtualSpeed = 3.0f;
